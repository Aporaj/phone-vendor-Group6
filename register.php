        ...
        <div class="mt-10">
            <div class="col-lg-8 col-md-8"><br>
                ...
                if (isset($_POST["login"])) {
                    ...
                    $usersResgister = "INSERT INTO users (fname, email, username, password)VALUE('$fullname', '$email', '$username', '$password')";
                    $userCreateAcc = mysqli_query($con, $usersResgister);
                ...
                <form method="post" action="register.php">
                    <div class="form-me">
                        ...
                        <input type="text" name="fname" placeholder="Enter your Fullname" required class="form-control">
                    </div>
                    <br>
                    <div class="form-me">
                    ...
                    <div class="button-group-area mt-40 button-me">
                        <div class="footer_widget">
                            <button type="submit" name="login" class="btn btn-design">Create account</button>
                            <span>Have an account <a href="login.php" target="_blank"> Login</a> </span>
                        </div>
                    </div>
                    <br>
                </form>
